...
const ProductCard: React.FC<ProductCardProps> = ({ title, id, image, price }) => {
  return (
    <div className="scale-90 flex flex-col border border-gray-300 rounded-lg p-4 h-[350px] w-full md:w-1/3 lg:w-1/4 m-2 bg-white shadow-sm hover:shadow-lg transition-shadow duration-300">
